...
func (bsql Basesql) FindWhere(model st.Abstracttblnew, result *string) {
	//	s := model.Id
	//	bsql.SQL.Select().Where().And().And(map[string]string)
}
...
func (b Basesql) Update(modelUpdate st.Abstracttbl, result *string) bool {
...
func (b Basesql) Insert(modelInsert st.Abstracttbl) int {
	dyn := make(map[string]interface{})
...
func (b Basesql) Getone(modelFind st.Abstracttbl, result *string) {
	var rows *sqlx.Rows
	dyn := make(map[string]interface{})
...
func (b Basesql) Find(modelFind st.Abstracttbl, result *string) {
	var filter string
	var rows *sqlx.Rows
	dyn := make(map[string]interface{})
	dyn = loadmodel(modelFind.Dt)
...
/* func (b Basesql) FindWhere(modelFind st.Abstracttbl, result *string) {
	var filter string
	var rows *sqlx.Rows
	var i int
	i = 0
...
func (b Basesql) Getall(modelFind st.Abstracttbl, result *string) {
	var rows *sqlx.Rows
	dyn := make(map[string]interface{})
	dyn = loadmodel(modelFind.Dt)
...
func (b Basesql) Gettablemeta(model st.Abstracttbl, result *string) {

}

func (b Basesql) Upload(model st.Abstracttbl, result *string) {
...
func (b Basesql) Gettable() string {
	return b.TableDB
}

func (b Basesql) Getid() int {
	return b.Idpk
}
